        ...
        <main>
            <section id="teams">
             ...
             <section id="team-member">
               <TeamMember imageUrl="/team-hilmatrix.jpg" name="Hilman Mauludin" role="Game Programmer"
             ...
             <section id="team-member">
               <TeamMember imageUrl="/team-anonymous.jpg" name="Yudhistira Irja Wiguna" role="2D Artist & Animator"
             ...
             <section id="team-member">
               <TeamMember imageUrl="/team-anonymous.jpg" name="Bill Galvin" role="3D Artist"
             ...
             <section id="team-member">
               <TeamMember imageUrl="/team-anonymous.jpg" name="Reihan" role="3D Animator"
